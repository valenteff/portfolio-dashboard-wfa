#!/usr/bin/env python3
"""
Essential Weight Variation Runner for Portfolio Backtest

This script runs the portfolio_backtest_weight.py script with the most important
weight combinations for profit, win rate, and recovery factor.
...
# Define the essential weight variations to test
WEIGHT_VARIATIONS = [
...
def main():
    """Run essential weight variations."""
    print(f"Starting essential weight variation tests with {len(WEIGHT_VARIATIONS)} combinations")
    ...
    # Print summary
    print("\n\n" + "="*100)
    print("ESSENTIAL WEIGHT VARIATION TESTS SUMMARY")
    print("="*100)
    ...
    print("="*100)
    print("All essential weight variation tests completed successfully!")
